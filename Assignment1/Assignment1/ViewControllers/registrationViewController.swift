...
class registrationViewController: UIViewController {
    ...
    @IBAction func submit(sender : UIButton)
    {
        ...
        user.createUser(theName: tfName.text!, theAddress: tfAddress.text!, thePhone: tfPhone.text!, theEmail: tfEmail.text!, theAge: Int(lbAge.text!)!, theGender: gender, theDOB: datePicker.date)
